# Build an Expense Tracker Python Project

This is the student starter repo for the [Build a Expense Tracker](https://codeling.dev/projects/build-a-expense-tracker/) project provided by [Codeling](https://codeling.dev).
